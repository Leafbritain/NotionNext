...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://nasal-lady-932.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '02ab3b8678004aa69e9e415905ef32a5,en:7c1d570661754c8fbc568e00a01fd70e',
  THEME: process.env.NEXT_PUBLIC_THEME || 'matery', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 claude,endspace,example,fukasawa,fuwari,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  LANG: process.env.NEXT_PUBLIC_LANG || 'zh-CN', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  SINCE: process.env.NEXT_PUBLIC_SINCE || 1900, // e.g if leave this empty, current year will be used.
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '我们之于彼此，不过是一种知觉。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://koimoyou.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '爱的狂信徒', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    process.env.NEXT_PUBLIC_GREETING_WORDS || '——心爱的，, 再会了。',
